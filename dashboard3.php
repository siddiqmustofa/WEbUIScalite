...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-10">
        ...
        <h2 class="text-3xl font-bold mb-6">Riwayat Room</h2>
        ...
        <div class="bg-white p-4 rounded-lg shadow overflow-x-auto">
            <table class="w-full table-auto">
                ...
                <?php foreach ($rooms as $room):
                    ...
                    $mod_query = "fullName=Admin&meetingID={$room['meeting_id']}&password={$room['moderator_pw']}";
                    $mod_checksum = sha1("join$mod_query$secret");
                    $mod_link = "$scalelite_url/join?$mod_query&checksum=$mod_checksum";

                    $att_query = "fullName=Peserta&meetingID={$room['meeting_id']}&password={$room['attendee_pw']}";
                    $att_checksum = sha1("join$att_query$secret");
                    $att_link = "$scalelite_url/join?$att_query&checksum=$att_checksum";
